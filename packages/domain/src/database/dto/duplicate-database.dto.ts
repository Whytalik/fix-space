...
import { DuplicateOptionsDto } from "../../common/dto/duplicate-options.dto";

export class DuplicateDatabaseDto extends DuplicateOptionsDto {
  @ApiProperty({ description: "New database title (1-120 chars)", example: "My Duplicated Database", required: false })
  @IsOptional()
