...
export class ChangePasswordDto {
  @ApiProperty({ description: "Current password", example: "OldStr@ngPass1", required: true })
  @IsString({ message: i18nValidationMessage<I18nTranslations>("validation.IS_STRING") })
  currentPassword: string;

  @ApiProperty({ description: "New password", example: "NewStr@ngPass1", required: true })
  @IsString({ message: i18nValidationMessage<I18nTranslations>("validation.IS_STRING") })
