...
export class DuplicateSectionDto extends DuplicateOptionsDto {
  @ApiProperty({ description: "New section name (1-120 chars)", example: "My Duplicated Section", required: false })
  @IsOptional()
