...
import { DatePreset, FilterField, FilterOperator } from "./record-filter.enums";

export { DatePreset, FilterField, FilterLogic, FilterOperator } from "./record-filter.enums";
...
export class RecordFilterDto {
  ...
  @ApiProperty({ enum: DatePreset, description: "Dynamic date preset (overrides operator/value for date properties)", required: false })
  @IsOptional()
  @IsEnum(DatePreset, { message: i18nValidationMessage<I18nTranslations>("validation.IS_ENUM") })
  preset?: DatePreset;
}
