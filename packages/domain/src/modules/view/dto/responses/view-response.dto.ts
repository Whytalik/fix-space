...
import { FilterLogic, RecordFilterDto } from "../../../record/dto/common/record-filter.dto";
import { RecordSortDto } from "../../../record/dto/common/record-sort.dto";
import { SummaryMetric } from "../../../record/dto/common/record-summary.enums";
...
export class ViewResponseDto {
  ...
  @ApiProperty({ description: "View position (order)", example: 0, required: true })
  @Expose()
  position: number;
  ...
  @ApiProperty({ description: "View config (advanced settings)", required: true, nullable: true })
  @Expose()
