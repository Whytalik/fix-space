...
Nucleus is a specialized operational system designed for CFD traders. It provides a comprehensive suite of tools to help traders of all levels structure their knowledge, manage statistics, and organize their daily trading activities.
...
└── packages
    ...
    ├── @repo/database            # Prisma schema, client, and seed scripts
