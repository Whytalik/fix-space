...
describe('RecordController', () => {
  ...
  describe('create', () => {
    it('should call recordService.create with databaseId, dto and userId', async () => {
      const dto = { name: 'New Record', icon: '📝' };
  ...
  describe('update', () => {
    it('should call recordService.update with id, dto and userId', async () => {
      const dto = { name: 'Updated Record' };
      const updatedResponse = { ...mockRecordResponse, name: 'Updated Record' } as unknown as RecordResponseDto;
