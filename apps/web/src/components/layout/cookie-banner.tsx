...
export function CookieBanner() {
  ...
  return isVisible ? (
    <div className="fixed bottom-6 left-6 right-6 z-[100] md:left-auto md:right-8 md:max-w-md animate-fade-up">
      <div className="bg-elevated border border-stroke rounded-2xl p-6 flex flex-col gap-4">
