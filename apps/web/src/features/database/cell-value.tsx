...
export function CellValue({ value, type, relatedRecords }: CellValueProps) {
  ...
  switch (type) {
    ...
    case PropertyType.STATUS: {
      const label =
        typeof value === "object" && value !== null ? ((value as Record<string, unknown>).label ?? String(value)) : String(value);
      const color =
        typeof value === "object" && value !== null ? ((value as Record<string, unknown>).color as string | undefined) : undefined;
      return (
