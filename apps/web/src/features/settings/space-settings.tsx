        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col rounded-lg border border-stroke overflow-hidden">
              {spaces.map((s, i) =>
                editingId === s.id ? (
                  <div key={s.id} className={`flex flex-col gap-2 px-3 py-2${i < spaces.length - 1 ? " border-b border-stroke" : ""}`}>
                  ...
                  >
                    ...
                    {!s.isDefault && (
                      <Button variant="ghost" size="sm" disabled={isSettingDefault !== null} onClick={() => handleSetDefault(s.id)}>
