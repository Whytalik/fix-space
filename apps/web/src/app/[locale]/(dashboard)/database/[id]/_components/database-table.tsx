...
export function DatabaseTable({ properties, records }: DatabaseTableProps) {
  ...
  const { relatedRecordsMap, invalidateRecords, activeView, wrapCells } = useDatabaseContext();
              ...
              {records.length === 0 ? (
                ...
                records.map((record) => (
                  <tr
                    ...
                    className="border-b border-stroke-subtle last:border-b-0 transition-colors duration-150 hover:bg-canvas-subtle cursor-pointer group"
                  >
                    <td
                      className="px-3 py-2 border-r border-b border-stroke-subtle bg-canvas group-hover:bg-canvas-subtle transition-colors duration-150"
                      ...
                      return (
                        <td
                          ...
                          className={cn(
                            ...
                            index === 0 &&
                              "sticky left-0 z-20 bg-canvas group-hover:bg-canvas-subtle transition-colors duration-150 shadow-[inset_-1px_0_0_0_var(--color-stroke-subtle)] bg-opacity-100 group-hover:bg-opacity-100",
                          )}
                        >
                          <div
                            className={cn(
