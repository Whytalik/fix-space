...
export function SectionHeader({ eyebrow, title, description, descriptionClassName, mb = "mb-10", align = "center" }: SectionHeaderProps) {
  const alignClass = align === "left" ? "text-left" : "text-center";
  const marginClass = align === "left" ? "" : "mx-auto";

  return (
    <div className={`${alignClass} ${mb}`}>
      {eyebrow && <p className="type-landing-eyebrow mb-2 animate-fade-up">{eyebrow}</p>}
