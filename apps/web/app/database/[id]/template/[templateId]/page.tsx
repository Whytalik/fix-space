...
export default function TemplatePage() {
  ...
  if (!template) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <p className="text-ink-secondary text-sm">Template not found.</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-canvas">
      ...
      {isDeleteDialogOpen && (
        <ConfirmDialog
          ...
          description={`"${template.name || "Untitled template"}" will be permanently deleted.`}
      ...
      {isDefaultConfirmOpen && (
        <ConfirmDialog
          ...
          description="This will replace the current default template. All new records will use this template by default."
      ...
      {isRemovingDefaultConfirmOpen && (
        <ConfirmDialog
          ...
          description="Another template will automatically become the default. New records will still use a template."
