...
export default function EditDatabasePage() {
  ...
  return (
    <div className="flex flex-1 min-h-0">
      ...
      <main className="flex-1 overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden px-8 py-10">
        <div className="text-center mb-6">
          <p className="text-sm text-ink-muted mb-1">Edit database</p>
          <h1 className="type-page-title">{database.title || database.name}</h1>
        </div>

        <div className="flex justify-center mb-8">
          <TabSwitcher items={EDIT_TABS} active={activeTab} onChange={setActiveTab} />
        </div>
