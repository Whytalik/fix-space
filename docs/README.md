...
| [05 Development](05-development/)     | Регламенти розробки (DoD, workflow), контракт API та стандарти інтерфейсу          |
...
- **Архітектурний проект** → [03-architecture/architecture.md](03-architecture/architecture.md)
- **Пресетна модель даних** → [03-architecture/preset-model.md](03-architecture/preset-model.md)
