...
| US-ID  | GitHub Issue | Test Case ID                                       | Test Scenario | Priority |
| ------ | ------------ | -------------------------------------------------- | ------------- | -------- |
| US-001 | #1           | TC-AUTH-001, TC-AUTH-002, TC-AUTH-003              | TS-AUTH-01    | P1       |
| US-002 | #2           | TC-AUTH-004, TC-AUTH-005, TC-AUTH-006              | TS-AUTH-02    | P1       |
| US-003 | #3           | TC-AUTH-007, TC-AUTH-008, TC-AUTH-009, TC-AUTH-010 | TS-AUTH-03    | P1       |
| US-004 | #5           | TC-AUTH-011, TC-AUTH-012, TC-AUTH-013, TC-AUTH-014 | TS-AUTH-06    | P1       |
| US-005 | #4           | TC-AUTH-015, TC-AUTH-016, TC-AUTH-017              | TS-AUTH-04    | P1       |
...
| US-011 | #35          | TC-WS-004, TC-WS-005, TC-WS-006 | TS-SPACE-01   | P1       |
| US-012 | #36          | TC-WS-007, TC-WS-008            | TS-SPACE-01   | P1       |
...
| US-ID  | GitHub Issue | Test Case ID                       | Test Scenario | Priority |
| ------ | ------------ | ---------------------------------- | ------------- | -------- |
| US-018 | #38          | TC-SEC-001, TC-SEC-002, TC-SEC-003 | TS-SPACE-01   | P1       |
| US-019 | #39          | TC-SEC-004, TC-SEC-005             | TS-SPACE-01   | P1       |
...
| US-025 | #32          | TC-DB-003, TC-DB-004, TC-DB-005 | TS-DB-01      | P1       |
| US-026 | #33          | TC-DB-006, TC-DB-007            | TS-DB-01      | P1       |
...
| US-ID  | GitHub Issue | Test Case ID                          | Test Scenario | Priority |
| ------ | ------------ | ------------------------------------- | ------------- | -------- |
| US-032 | #9           | TC-PROP-001, TC-PROP-002, TC-PROP-003 | TS-PROP-01    | P1       |
| US-033 | #10          | TC-PROP-004, TC-PROP-005, TC-PROP-006 | TS-PROP-01    | P1       |
| US-034 | #30          | TC-PROP-007, TC-PROP-008, TC-PROP-009 | TS-PROP-01    | P1       |
...
| US-043 | #11          | TC-REC-004, TC-REC-005                           | TS-REC-01     | P1       |
| US-044 | #13          | TC-REC-006, TC-REC-007                           | TS-REC-01     | P1       |
| US-045 | #12          | TC-REC-008, TC-REC-009, TC-REC-010               | TS-REC-01     | P1       |
| US-046 | #28, #190    | TC-REC-011, TC-REC-012, TC-REC-013, TC-TRASH-006 | TS-REC-04     | P1       |
...
| US-050 | #53          | TC-REC-020, TC-REC-021, TC-REC-022               | —             | P2       |
| US-051 | #54          | TC-REC-023, TC-REC-024                           | —             | P2       |
| US-052 | #82          | TC-REC-025, TC-REC-026                           | —             | P2       |

## 7. Record Content (US-053 — US-065)

| US-ID  | GitHub Issue | Test Case ID                          | Test Scenario | Priority |
| ------ | ------------ | ------------------------------------- | ------------- | -------- |
| US-053 | #23          | TC-CONT-001, TC-CONT-002, TC-CONT-003 | —             | P1       |
| US-054 | #24          | TC-CONT-004, TC-CONT-005, TC-CONT-006 | —             | P1       |
| US-055 | #25          | TC-CONT-007, TC-CONT-008, TC-CONT-009 | —             | P1       |
...
| US-068 | #87          | TC-TMPL-007, TC-TMPL-008              | TS-TMPL-01    | P2       |
...
| US-ID  | GitHub Issue | Test Case ID                          | Test Scenario | Priority |
| ------ | ------------ | ------------------------------------- | ------------- | -------- |
| US-072 | #14          | TC-VIEW-001, TC-VIEW-002              | TS-REC-01     | P1       |
| US-073 | #17          | TC-VIEW-003, TC-VIEW-004              | TS-REC-01     | P1       |
| US-074 | #29          | TC-VIEW-005, TC-VIEW-006              | TS-REC-01     | P1       |
| US-075 | #18          | TC-VIEW-007, TC-VIEW-008, TC-VIEW-009 | TS-REC-02     | P1       |
...
| US-082 | #67          | TC-VIEW-023, TC-VIEW-024              | —             | P2       |
...
| US-ID  | GitHub Issue | Test Case ID                                | Test Scenario | Priority |
| ------ | ------------ | ------------------------------------------- | ------------- | -------- |
| US-085 | #47          | TC-SEARCH-001, TC-SEARCH-002, TC-SEARCH-003 | —             | P2       |
| US-086 | #47          | TC-SEARCH-004, TC-SEARCH-005                | —             | P2       |
...
| US-089 | #50          | TC-IMP-006, TC-IMP-007, TC-IMP-008 | —             | P2       |
| US-090 | #104         | TC-IMP-009, TC-IMP-010             | —             | P3       |

## 12. Formulas (US-098 — US-101)

| US-ID  | GitHub Issue | Test Case ID                          | Test Scenario | Priority |
| ------ | ------------ | ------------------------------------- | ------------- | -------- |
| US-098 | #19          | TC-FORM-001, TC-FORM-002, TC-FORM-003 | —             | P1       |
...
| US-ID  | GitHub Issue | Test Case ID                          | Test Scenario | Priority |
| ------ | ------------ | ------------------------------------- | ------------- | -------- |
| US-102 | #59          | TC-AUTO-001, TC-AUTO-002              | —             | P2       |
| US-103 | #59          | TC-AUTO-003, TC-AUTO-004, TC-AUTO-005 | —             | P2       |
| US-104 | #59          | TC-AUTO-006, TC-AUTO-007              | —             | P2       |
| US-105 | #60          | TC-AUTO-008, TC-AUTO-009              | —             | P2       |
...
| US-ID  | GitHub Issue | Test Case ID                       | Test Scenario | Priority |
| ------ | ------------ | ---------------------------------- | ------------- | -------- |
| US-125 | #73          | TC-ONB-001, TC-ONB-002, TC-ONB-003 | —             | P2       |
| US-126 | #100         | TC-ONB-004, TC-ONB-005             | —             | P2       |
...
| US-ID  | GitHub Issue | Test Case ID                             | Test Scenario | Priority |
| ------ | ------------ | ---------------------------------------- | ------------- | -------- |
| US-130 | #102         | TC-NOTIF-001, TC-NOTIF-002, TC-NOTIF-003 | —             | P2       |
| US-131 | #103         | TC-NOTIF-004, TC-NOTIF-005               | —             | P2       |
...
| US-ID  | GitHub Issue | Test Case ID           | Test Scenario | Priority |
| ------ | ------------ | ---------------------- | ------------- | -------- |
| US-091 | #105         | TC-INT-001, TC-INT-002 | —             | P3       |
...
| US-096 | #108         | TC-INT-011, TC-INT-012 | —             | P3       |
| US-097 | #109         | TC-INT-013, TC-INT-014 | —             | P3       |

## 20. Trash (US-134 — US-135)

| US-ID  | GitHub Issue | Test Case ID                             | Test Scenario | Priority |
| ------ | ------------ | ---------------------------------------- | ------------- | -------- |
| US-134 | #48          | TC-TRASH-001, TC-TRASH-002, TC-TRASH-003 | —             | P2       |
| US-135 | #70          | TC-TRASH-004, TC-TRASH-005               | —             | P2       |

## 21. Customization (US-136 — US-137)

| US-ID  | GitHub Issue | Test Case ID             | Test Scenario | Priority |
| ------ | ------------ | ------------------------ | ------------- | -------- |
| US-136 | #116         | TC-CUST-001, TC-CUST-002 | —             | P3       |
| US-137 | #122         | TC-CUST-003, TC-CUST-004 | —             | P3       |
...
| --------------- | --- | --- | ------------------------ |
| Authentication  | 9   | 27  | TS-AUTH-01 — TS-AUTH-06  |
| Workspace       | 8   | 21  | TS-SPACE-01, TS-SPACE-02 |
| Sections        | 6   | 14  | TS-SPACE-01              |
| Databases       | 8   | 21  | TS-DB-01, TS-DB-02       |
| Properties      | 10  | 25  | TS-PROP-01               |
| Records         | 11  | 26  | TS-REC-01, TS-REC-04     |
| Record Content  | 13  | 31  | —                        |
| Templates       | 6   | 15  | TS-TMPL-01               |
| Views           | 13  | 28  | TS-REC-01 — TS-REC-03    |
| Global Search   | 2   | 5   | —                        |
| Import & Export | 4   | 10  | —                        |
| Formulas        | 4   | 10  | —                        |
| Automations     | 6   | 13  | —                        |
| Buttons         | 4   | 8   | —                        |
| Statistics      | 5   | 11  | —                        |
| Settings        | 8   | 18  | TS-USER-01, TS-USER-03   |
| Onboarding      | 5   | 11  | —                        |
| Notifications   | 4   | 9   | —                        |
| Integrations    | 7   | 14  | —                        |
| Trash           | 2   | 5   | —                        |
