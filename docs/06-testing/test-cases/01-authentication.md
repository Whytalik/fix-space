...
## 1. Authentication (TC-AUTH-001 — TC-AUTH-037, TC-AUTH-U-001 — TC-AUTH-U-008)
...
## Unit Tests — Authentication (TC-AUTH-U-001 — TC-AUTH-U-008)

### [ ] TC-AUTH-U-001: AuthService.register — створення користувача та хешування пароля
...
### [ ] TC-AUTH-U-002: AuthService.verifyEmail — валідація токену та активація профілю
...
### [ ] TC-AUTH-U-003: AuthService.login — перевірка облікових даних та верифікації
...
### [ ] TC-AUTH-U-005: AuthService.requestPasswordReset — генерація одноразового токену скидання
...
### [ ] TC-AUTH-U-006: AuthService.resetPassword — зміна пароля та анулювання сесій
