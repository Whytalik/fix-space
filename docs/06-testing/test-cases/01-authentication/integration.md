...
### [x] TC-AUTH-001: Реєстрація з валідними даними
...
### [x] TC-AUTH-002: Реєстрація з невалідним email
...
### [x] TC-AUTH-003: Реєстрація з існуючим email
...
### [x] TC-AUTH-004: Верифікація email з валідним токеном
...
### [x] TC-AUTH-005: Верифікація з невалідним токеном
...
### [x] TC-AUTH-007: Вхід з валідними даними
...
### [x] TC-AUTH-008: Вхід з неправильним паролем
...
### [x] TC-AUTH-009: Вхід з неіснуючим email
...
### [x] TC-AUTH-010: Вхід без верифікації email
...
### [x] TC-AUTH-011: Скидання пароля — запит
...
### [x] TC-AUTH-012: Скидання пароля — встановлення нового пароля
...
### [x] TC-AUTH-013: Скидання пароля — прострочений токен
...
### [x] TC-AUTH-015: Оновлення токена — успішний refresh
...
### [x] TC-AUTH-017: Refresh — відсутній токен
...
### [x] TC-AUTH-038: Запит до захищеного ендпоінту без токена автентифікації
