...
| `expiresAt` | DateTime  | —        | Термін дії (7 днів від видачі, продовжується при ротації)             |
...
| `icon`               | String    | ✓        | Emoji або URL іконки                                                      |
| `position`           | Int       | —        | Порядок бази в UI                                                         |
...
| `isKey`              | Boolean   | —        | Системна/ключова база даних                                               |
...
| `integrationKey`      | String       | ✓        | Ключ зіставлення для інтеграції (напр. "pair", "entryPrice")                                               |
| `createdAt`           | DateTime     | —        | Час створення                                                                                              |
| `updatedAt`           | DateTime     | —        | Час останньої зміни                                                                                        |
| `config`              | Json         | ✓        | Конфігурація специфічна для типу (формати, опції, обмеження)                                               |
| `visibilityCondition` | Json         | ✓        | Умова динамічної видимості властивості в UI                                                                |
...
| `deletedAt`           | DateTime  | ✓        | Час м'якого видалення                            |
| `createdAt`           | DateTime  | —        | Час створення                                    |
| `updatedAt`           | DateTime  | —        | Час останньої зміни                              |
...
| `recordLimit`        | Int         | ✓        | Максимальний ліміт записів                              |
| `useDefaultTemplate` | Boolean     | —        | Використовувати дефолтний шаблон                        |
| `defaultTemplateId`  | UUID (FK)   | ✓        | → `Template`                                            |
| `filters`            | Json        | ✓        | Збережена конфігурація фільтрів (`FilterSet`)           |
| `filterLogic`        | FilterLogic | —        | Логіка фільтрації: `AND` / `OR`                         |
...
| `config`             | Json        | ✓        | Додаткова конфігурація подання                          |
| `createdAt`          | DateTime    | —        | Час створення                                           |
| `updatedAt`          | DateTime    | —        | Час останньої зміни                                     |
