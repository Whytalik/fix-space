...
_Детальний опис користувацького інтерфейсу та пресетів див. у [Специфікації формул](../02-requirements/functional/3.13-formulas.md)._
...
_Опис тригерів та дій для користувача див. у [Специфікації автоматизацій](../02-requirements/functional/3.14-automations.md)._
